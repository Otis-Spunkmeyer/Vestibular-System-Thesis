...
def make_multiplication_network():
    ...
    syn2 = Synapse(gs_inh, Es_inh, Elo, Ehi, name="mul_pre2_to_mod", pre="mul_pre2", post="mul_mod") # inhibitory: gain input reduces mod below R, relieving mod's inhibition of prod
